 ...
 *
 * This is a modified version of 1.5.0 release (commit 6efe52e) with removed
 * dependency to core.console library of the jquery-sparkle package.
	...
	if ( !($.History||false) ) {
		...
		$.History = {
			...
			domReady: function ( ) {
				...
				// Runonce
				if ( History.domReadied ) {
					return;
				}
				History.domReadied = true;
		...
		window.console && window.console.warn('$.History has already been defined...');
	}
